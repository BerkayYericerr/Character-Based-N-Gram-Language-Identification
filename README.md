...
This project demonstrates how character-based n-gram models can distinguish between two languages based solely on text structure,
without requiring word-level tokenization or linguistic resources.
